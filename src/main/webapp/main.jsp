...
<head>
    ...
    <title>Veloce Rentals ⚬ HomePage</title>
    <!-- Favicon-->
...
<header class="bg-dark py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">Veloce Rentals</h1>
            <p class="lead fw-normal text-white-50 mb-0">Car rental at the best prices</p>
        </div>
    </div>
</header>
<!-- Section-->
...
<footer class="py-5 bg-dark">
    <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Veloce Rentals 2024</p></div>
</footer>
<!-- Bootstrap core JS-->
